"""Configuración del pipeline de zonificación agronómica.

Este módulo define las clases y estructuras de datos para
cargar, validar y administrar la configuración completa del
sistema, siguiendo las pautas de ISO 42001 para IA responsable.
"""
...
class ModelConfig:
    ...
    Incluye parámetros para clustering, PCA y preprocesamiento.
    """
    ...
    def validate(self) -> bool:
        """Valida parámetros básicos del modelo."""
...
class ValidationConfig:
    ...
    Define criterios de calidad para datos espectrales, áreas y muestreo.
    """
...
class ZoningConfig:
    ...
    Integra `ModelConfig` y `ValidationConfig` según ISO 42001.
    """
    ...
    # Cumplimiento ISO 42001 - gobernanza y riesgos
    ...
    def validate_all(self) -> bool:
        """Valida toda la configuración completa."""
        self.model.validate()
    ...
    def from_file(cls, config_path: Path) -> "ZoningConfig":
        """Carga configuración desde un archivo JSON y convierte enums."""
...
def load_config(config_path: Optional[Path] = None) -> ZoningConfig:
    """Carga configuración desde archivo o retorna la configuración por defecto."""
